...
urlpatterns = [
    ...
    url(r'^datosFacturacion/(?P<idCliente>[0-9]+)/$', views.datosFacturacionView, name='datosFacturacion'),
    url(r'^datosFacturacionAuth/(?P<idCliente>[0-9]+)/$', views.datosFacturacionAuth, name='datosFacturacionAuth'),
